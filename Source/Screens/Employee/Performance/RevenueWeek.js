            ...
            }
            {
                <View>
                    <View style={{ backgroundColor: '#141313', marginTop: 23, marginLeft: 16, marginRight: 16 }}>
                        <Text style={{ textAlign: 'center', color: '#FFFFFF', fontSize: 16, fontFamily: 'Avenir-Heavy', lineHeight: 22, marginTop: 9, marginBottom: 10 }}>August</Text>
                    </View>
                    <View style={{ flexDirection: 'row', marginLeft: 17, borderBottomWidth: 1, marginRight: 16, borderColor: '#979797' }}>
                        {
                            weekdays.map((res) => {
                                return (
                                    <Text style={{ color: '#1A1919', fontFamily: 'Avenir-Heavy', lineHeight: 19, borderLeftWidth: 1, width: 51, paddingTop: 7, textAlign: 'center', borderRightWidth: 1, borderColor: '#979797' }}>{res}</Text>
                                )
                            })
                        }
                    </View>
