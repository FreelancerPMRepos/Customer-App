...
const StylesDescription = ({ navigation, route, props }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            {
                <ScrollView>
                    <View style={{ flexDirection: 'row', marginBottom: 10, marginTop: 10, marginLeft: 20, marginRight: 20, justifyContent: 'space-between' }}>
                        <Image
                            style={{ height: 280, width: width * 0.42 }}
                            source={{ uri: styleData.upload_front_photo === null ? styleData.upload_right_photo : styleData.upload_front_photo }}
                        />
                        <Image
                            style={{ height: 280, width: width * 0.42 }}
                            source={{ uri: styleData.upload_back_photo === null ? styleData.upload_left_photo : styleData.upload_back_photo }}
                        />
                    </View>
                    <View style={{ flexDirection: 'row', marginLeft: 16, justifyContent: 'space-between', marginRight: 68 }}>
                        <View>
                            ...
                            <Text style={{ fontFamily: 'Avenir-Medium', lineHeight: 19, color: '#141313' }}>{styleData.name}</Text>
                        </View>
                        <View>
                    ...
                    <Text style={{ fontFamily: 'Avenir-Medium', lineHeight: 19, marginLeft: 17, marginTop: 8, color: '#141313' }}>{styleData.description}</Text>
                    <Text style={{ fontFamily: 'Avenir-Heavy', fontSize: 16, lineHeight: 22, color: '#141313', marginLeft: 16, marginTop: 30.67 }}>Materials</Text>
                    <Text style={{ fontFamily: 'Avenir-Medium', lineHeight: 19, color: '#141313', marginLeft: 16, marginTop: 8 }}>{styleData.materials}</Text>
